...
When you finish work on a ticket, **don't move it straight to Done.** The handoff flow is:

1. Complete implementation + create PR
2. Move ticket to **"In Review"**
3. **Assign Scout** — Scout handles verification and moves to Done

This applies to all tickets, whether they pass or fail (draft PR with failure summary still gets assigned to Scout).
